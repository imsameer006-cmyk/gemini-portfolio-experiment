  ...
  return (
    <section id={toSectionId(eyebrow)} className="max-w-[1100px] mx-auto px-6 md:px-10 lg:pl-[150px] xl:pl-10 pt-16 md:pt-24 border-t border-[#E6E3DD]">
      <Reveal>
        ...
        <h2 className="font-display text-[clamp(26px,3.6vw,36px)] leading-tight text-[#18171A] mb-2">
    ...
    <main className="bg-[#F9F8F5] pb-32">
      ...
      <header className="relative flex md:min-h-screen flex-col justify-start max-w-[1100px] mx-auto px-6 md:px-10 lg:pl-[150px] xl:pl-10 pt-16 md:pt-24 pb-8">
        <Reveal>
          ...
          <h1 className="font-display text-[clamp(38px,6vw,60px)] leading-tight text-[#18171A] mb-5 max-w-[16ch]">
      ...
      <Chapter num="03" eyebrow="Typography" heading="Two voices," headingItalic="strict roles."
        description="Open Sans upright carries narrative moments and is never body text. Geist carries facts. Letter-spacing lives only on labels.">
        <Reveal className="mt-8 divide-y divide-[#E6E3DD] border-t border-[#E6E3DD]">
          {[
            { tok: "type.hero", sample: "Building clarity out of complexity.", style: "font-display text-[clamp(28px,4.2vw,44px)]", rule: "Open Sans upright · homepage hero only" },
            { tok: "type.section-heading", sample: "The system behind the site.", style: "font-display text-[clamp(22px,3vw,30px)]", rule: "Major section / case-study headings" },
