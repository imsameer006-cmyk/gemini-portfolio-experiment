...
export default function NotFound() {
  return (
    <section className="relative flex flex-col items-center justify-center px-6 pb-10 pt-[76px] text-center md:min-h-[80svh] md:px-10 md:pb-12 md:pt-[92px]">
      ...
      <p className="mt-5 max-w-[46ch] text-base leading-relaxed text-[var(--color-text-secondary)]">
        The link you followed doesn&apos;t lead anywhere — but the rest of the site does.
      </p>
      <Link
        href="/"
        className="mt-10 inline-flex min-h-[44px] items-center gap-2 rounded-full bg-[var(--color-text)] px-5 py-3 text-sm font-medium text-[var(--color-warm-bg)] transition-colors duration-200 hover:bg-[var(--color-accent)]"
      >
        Back to home
