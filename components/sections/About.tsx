      ...
      <div className="mx-auto max-w-[1280px] border-t border-[#E6E3DD] pt-16">
        ...
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-stretch lg:gap-20">
          ...
          <div>
            <motion.h2
              {...reveal()}
              className="font-display text-[clamp(2rem,4.5vw,3.5rem)] leading-tight text-[#18171A]"
            >
            ...
            <motion.p
              {...reveal(0.14)}
              className="mt-10 max-w-[420px] font-display text-[clamp(1.2rem,1.6vw,1.5rem)] leading-[1.45] text-[#5F5A54]"
            >
              Think in systems.
              <br />
              Design for humans.
