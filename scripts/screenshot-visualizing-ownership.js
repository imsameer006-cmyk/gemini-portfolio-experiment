...
(async () => {
  ...
  await page.goto('http://localhost:3000/screens/visualizing-ownership.html', {
  ...
  const outPath = path.join(__dirname, '../public/case-studies/gemini/visualizing-ownership.png');
