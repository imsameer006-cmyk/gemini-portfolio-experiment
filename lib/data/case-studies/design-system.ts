      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              heading: "Finding 02 — An accessibility claim that was only half true.",
            ...
            {
              heading: "Finding 03 — Motion had the same drift as color.",
        ...
        },
        {
          ...
          before: {
            ...
            items: [
              ...
              { label: "partial · homepage broken", detail: "accessibility" },
            ],
          },
          after: {
            ...
            items: [
              ...
              { label: "2 shared hooks", detail: "scroll reveal" },
